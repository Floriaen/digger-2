/**
 * @file maggot-eater.component.js
 * @description Behaviour component that lets maggots consume diggable blocks instantly.
 */
...
export class MaggotEaterComponent extends Component {
  constructor({ spawn }) {
    super({ spawn });
  }
