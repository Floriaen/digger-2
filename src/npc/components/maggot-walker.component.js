/**
 * @file maggot-walker.component.js
 * @description Horizontal crawl behaviour for maggots.
 */
...
import { MaggotEaterComponent } from './maggot-eater.component.js';
import { MaggotFallComponent } from './maggot-fall.component.js';

const WALK_SPEED_PX_PER_MS = 0.01; // ~2 tiles per second

export class MaggotWalkerComponent extends Component {
  update(entity, deltaTime, { game, terrain }) {
    ...
    const eater = entity.get(MaggotEaterComponent);
    const fall = entity.get(MaggotFallComponent);
